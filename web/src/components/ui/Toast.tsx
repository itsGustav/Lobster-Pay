...
function ToastContainer({ toasts, onClose }: { toasts: Toast[]; onClose: (id: string) => void }) {
  ...
  return (
    <div className="fixed top-4 right-4 z-[1060] flex flex-col gap-3 max-w-md">
      {toasts.map((toast) => (
...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: (id: string) => void }) {
  ...
  const styles = {
    success: 'bg-gray-900 border-green-500/50 text-green-500',
    error: 'bg-gray-900 border-red-500/50 text-red-500',
    warning: 'bg-gray-900 border-orange-600/50 text-orange-600',
    info: 'bg-gray-900 border-blue-500/50 text-blue-500',
  };
